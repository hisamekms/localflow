...
COMPLETE_OUT2="$(run_lf complete "$TASK_ID2")"
...
FAIL_OUT="$(run_lf complete "$TASK_ID3" 2>&1 || true)"
...
FAIL_OUT2="$(run_lf complete "$TASK_ID4" 2>&1 || true)"
...
FAIL_OUT3="$(run_lf complete "$TASK_ID5" 2>&1 || true)"
...
COMPLETE_OUT3="$(run_lf complete "$TASK_ID6")"
...
COMPLETE_OUT4="$(run_lf complete "$TASK_ID7")"
...
FAIL_OUT4="$(run_lf complete "$TASK_ID8" 2>&1 || true)"
...
COMPLETE_OUT5="$(run_lf complete "$TASK_ID9")"
