...
# 7. Daemon mode creates default log file
echo "[7] Daemon creates default log file"
...
# 8. Log file contains event entries
echo "[8] Log file contains event entries"
...
# 9. Custom --log-file path
echo "[9] Custom --log-file path"
...
# 10. Hook execution logged
echo "[10] Hook execution logged"
